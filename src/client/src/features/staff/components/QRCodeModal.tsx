    ...
    <div className="fixed inset-0 bg-black/70 backdrop-blur-sm flex items-center justify-center z-50 p-4">
      <div className="bg-zinc-900 border border-zinc-800 rounded-3xl p-8 max-w-md w-full">
        ...
        <div ref={qrRef} className="bg-white rounded-2xl p-6 mb-6">
          ...
          />
          <p className="text-center text-zinc-600 text-sm mt-4 font-medium">{queueName}</p>
        </div>

        {/* URL Display */}
        <div className="bg-zinc-800 rounded-xl p-3 mb-6">
          <p className="text-xs text-zinc-500 mb-1">Join link</p>
          <p className="text-sm text-zinc-300 font-mono truncate">{joinUrl}</p>
        </div>
        ...
        <div className="grid grid-cols-2 gap-3">
          <button
            ...
            className="py-3 bg-zinc-800 text-white rounded-xl font-medium hover:bg-zinc-700 transition-colors flex items-center justify-center gap-2"
          >
          ...
          <button
            ...
            className="py-3 bg-white text-zinc-900 rounded-xl font-semibold hover:bg-zinc-100 transition-colors flex items-center justify-center gap-2"
          >
            <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
