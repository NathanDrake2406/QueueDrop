...
export function QRCodeModal({ businessSlug, queueSlug, queueName, onClose }: QRCodeModalProps) {
  ...
  return (
    <div className="fixed inset-0 bg-black/70 backdrop-blur-sm flex items-center justify-center z-50 p-4">
      <div className="bg-slate-900 border border-slate-800 rounded-none p-8 max-w-md w-full">
        {/* Header */}
        ...
        {/* QR Code */}
        <div ref={qrRef} className="bg-white rounded-none p-6 mb-6">
          <QRCodeSVG
            value={joinUrl}
            size={256}
            level="H"
        ...
        {/* URL Display */}
        <div className="bg-slate-800 rounded-none p-3 mb-6">
        ...
        <div className="grid grid-cols-2 gap-3">
          <button
            ...
            className="py-3 bg-slate-800 text-white rounded-none font-medium hover:bg-slate-700 transition-colors flex items-center justify-center gap-2"
          >
          ...
          <button
            ...
            className="py-3 bg-white text-slate-900 rounded-none font-semibold hover:bg-slate-100 transition-colors flex items-center justify-center gap-2"
          >
            <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
